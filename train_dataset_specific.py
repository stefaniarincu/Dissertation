...
DATASET_NAME = 'kits' # 'isles', 'bmshare', 'brats', 'brats_ped', 'lits', 'kits', 'lung'
DATASET_PATH = f'{ROOT_PATH}/datasets/{DATASET_NAME}'

# Constant for model checkpoint path and log path
MODELS_AND_LOG_ROOT_PATH = f'{EXPERIMENTS_ROOT_PATH}/dataset_specific/fract/tresunet/exp3/{DATASET_NAME}'
