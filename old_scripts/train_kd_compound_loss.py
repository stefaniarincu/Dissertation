...
DATASET_NAME = 'brats' # 'bmshare', 'brats', 'brats_ped'
...
MODELS_AND_LOG_ROOT_PATH = f'{ROOT_PATH}/files/kd/fused_not_weighted_no_cross_attention_10K_samples_4ds_new_dropout/v3/{DATASET_NAME}'
