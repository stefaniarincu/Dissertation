...
MODELS_AND_LOG_ROOT_PATH = f'{ROOT_PATH}/files/final_experiments/kd/from_fused_not_weighted_no_cross_attention_10K_samples_3ds_new_dropout/batch_size_{HYPERPARAMETERS["batch_size"]}_with_augmentations_3_features_projected/{DATASET_NAME}'
...
if __name__ == '__main__':
    ...
    # Feature aligner
    aligner = FeatureAligner([64, 256, 512], [192, 768, 1536]).to(DEVICE)
