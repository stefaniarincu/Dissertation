...
from utils import seed_all, create_log_file, print_and_save, save_resume_checkpoint, load_resume_checkpoint, load_dataset_specific_models, create_optimizer
...
if __name__ == '__main__':
    ...
    model = FusedTResUnetModel(dataset_specific_models).to(DEVICE)
